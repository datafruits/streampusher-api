class Api::Shrimpos::ShrimpoEntries::VotesController < ApplicationController
  def create
    ...
    if vote.save
      ActiveSupport::Notifications.instrument 'shrimpo.vote.created', title: shrimpo_entry.title, username: entry.user.username, score: vote.score
      render json: vote
    else
      ActiveSupport::Notifications.instrument 'shrimpo.vote.create.error', title: shrimpo_entry.title, username: entry.user.username, score: vote.score, errors: vote.errors, params: params
