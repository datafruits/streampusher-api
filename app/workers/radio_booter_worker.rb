...
class RadioBooterWorker
  ...
  def perform radio_id
    ...
    redis.hset 'proxy-domain', "#{radio.virtual_host}/icecast", icecast_container.host_port
    ...
    redis.hset 'proxy-domain', "#{radio.virtual_host}/liquidsoap", liquidsoap_container.host_port
  end
end
