...
RSpec.describe ShowSeries, type: :model do
  ...
  describe "recurring cadence" do
    it 'validates uniqueness based on month scope' do
      ...
      show_c = ShowSeries.new title: "live coding for dogs", recurring_interval: "month", recurring_weekday: 'Sunday', recurring_cadence: 'Second', start_time: Date.today.beginning_of_month, end_time: Date.today.beginning_of_month + 1.hours, start_date: Date.today.beginning_of_month
