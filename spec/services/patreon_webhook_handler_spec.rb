...
describe PatreonWebhookHandler do
  it 'saves the pledge to the db and sends a notification' do
    VCR.use_cassette(RSpec.current_example.metadata[:full_description].to_s) do
      # "currently_entitled_tiers\"=>{\"data\"=>[{\"id\"=>\"2647278\", \"type\"=>\"tier\"}]}, \"user\"=>{\"data\"=>{\"id\"=>\"17537828\", \"type\"=>\"user\"}, \"links\"=>{\"related\"=>\"https://www.patreon.com/api/oauth2/v2/user/17537828\"}}}, \"type\"=>\"member\"}",
      ...
      data= {"attributes"=>
             {"access_expires_at"=>nil,
              ...
              "full_name"=>"Anthony Allen Miller",
              "is_follower"=>false,
              "is_free_member"=>nil,
              "is_free_trial"=>nil,
              ...
              "relationships"=>
             {
              "currently_entitled_tiers" => { "data"=> [{ "id"=> "2647278", "type"=>"tier" }] },
               "address"=>
              {"data"=>{"id"=>"826453", "type"=>"address"},
               "links"=>{"related"=>"https://www.patreon.com/api/addresses/826453"}},
              "campaign"=>
              {"data"=>{"id"=>"205222", "type"=>"campaign"},
               "links"=>{"related"=>"https://www.patreon.com/api/campaigns/205222"}},
              "user"=>
              {"data"=>{"id"=>"1018897", "type"=>"user"},
               "links"=>{"related"=>"https://www.patreon.com/api/user/1018897"}}},
             "type"=>"member"
      }
